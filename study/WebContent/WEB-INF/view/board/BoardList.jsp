...
<title>리스트</title>
<c:import url="/inc/lib.jsp"/>
</head>
<body>
	<c:import url="/inc/navbar.jsp"/>
	<div class="container">
		<br>
		<a href="/board/boardInsertForm.do">등록</a>
	<form action="">
		<table class="table">
			<thead>
				<tr>
					<th>
						<select name="whereType">
							<option value="title" 
									${param.whereType eq 'title' ?   'selected="selected"' :''}>제목</option>
							<option value="contents" 
									${param.whereType eq 'contents' ?  'selected="selected"' : ''}>내용</option>
						</select>
					</th>
					<th>
				...
				<tr>
					<th>
						<select name="serviceType">
							...
							<option value="FAQ"
								${param.serviceType == 'FAQ' ?  'selected="selected"' :''}>F&Q </option>
						</select>
					</th>
					<th>
